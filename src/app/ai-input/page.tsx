...
export default function AiInputPage() {
  const { aiConfig, updateAiConfig, isSuperAdmin } = useFinance();
  ...
  return (
    <div className="max-w-md md:max-w-xl mx-auto px-4 py-5 space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        {isSuperAdmin ? (
          <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800 p-1 rounded-xl text-[11px] font-semibold border border-slate-200/80 dark:border-slate-700/80 shadow-sm">
            <button
              type="button"
              onClick={() => updateAiConfig({ provider: 'gemini' })}
              title="Gunakan Google Gemini resmi"
            ...
            <button
              ...
              title="Auto Switch (Prioritas Gemini ➔ Custom)"
              className={`px-2 py-1 rounded-lg transition-all ${
